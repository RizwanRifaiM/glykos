  ...
  return (
    <g>
      ...
      <circle
        ...
        strokeWidth="1.5"
      />
      <rect x={anchor.x + 12} y={anchor.y - 17} width="112" height="34" rx="10" fill="#ffffff" stroke={color} strokeWidth="1.5" />
      <text x={anchor.x + 24} y={anchor.y - 3} fontSize="12" fontWeight="800" fill={COLORS.navy}>
        {value}°C
      </text>
      <text x={anchor.x + 24} y={anchor.y + 11} fontSize="9.5" fill={COLORS.blue}>
        {id}
      </text>
    </g>
  )
